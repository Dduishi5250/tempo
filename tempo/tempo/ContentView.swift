...
// MARK: - 날씨 데이터 모델 (이전에 추가한 코드)
// ... WeatherResponse, Coord, Weather, Main 구조체는 기존과 동일하게 유지 ...
...
class LocationManager: NSObject, ObservableObject, CLLocationManagerDelegate {
    ...
    private let apiKey = "14494c4f25ac1c5c41b1be4377337dfe" // 발급받은 API 키 입력
    // 앱 그룹 ID를 여기에 정의합니다. (Step 7에서 설정한 것과 정확히 일치해야 함!)
